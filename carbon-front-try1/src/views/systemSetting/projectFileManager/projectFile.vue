    ...
    <div class="divBox">
      <div class="content-container">
        <div class="container">
          ...
          <button class="light-green-btn" style="margin-top: 2px; margin-bottom: 15px" @click="onClickSearch">查询</button>
          <button style="margin-top: 2px; margin-bottom: 15px; margin-left: 10px; width: 103px" class="normal-white-btn"
            @click="onUpload()">
            +上传文档
          </button>
        </div>
      ...
      <div>
        <el-table :header-cell-style="{
          ...
          <el-table-column align="left" prop="projectRegistryName" label="所属项目" min-width="180" />
          <el-table-column align="left" prop="title" label="文档名称" min-width="330" />
          <el-table-column align="left" prop="type" label="文档类型" min-width="100" />
          <el-table-column align="left" prop="finishTime" label="完成日期" min-width="100" />
          <el-table-column align="left" prop="updateTime" label="更新日期" min-width="100" />
...
export default {
  ...
  methods: {
    ...
    onClickAdd() {
      ...
      openUrlInNewWindow(this.methodUrl1);
    },
    onUpload() {
