      ...
      <div class="content-container">
        <div class="container">
          ...
          <div style="margin-left: 10px; width: 200px" class="selectbox-root">
            <span class="selectbox-hint" style="min-width: 80px">领域</span>
            <div class="selectbox-deliver" />
            <el-cascader
                placeholder="全部"
                @change="update"
          ...
          <div style="margin-left: 10px; width: 200px" class="selectbox-root">
            <span class="selectbox-hint" style="min-width: 80px">类型</span>
            <div class="selectbox-deliver" />
            <el-cascader
                placeholder="全部"
                @change="update"
          ...
          <div style="margin-left: 10px; width: 200px" class="selectbox-root">
            <span class="selectbox-hint" style="min-width: 80px">状态</span>
            <div class="selectbox-deliver" />
            <el-cascader
                placeholder="全部"
                @change="update"
          ...
          <div
              style="width: 220px; margin-left: 10px; padding: 0 0 0 0"
          ...
          <div
              style="width: 230px; margin-left: 10px; padding: 0 0 0 0"
              class="selectbox-root"
          >
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      if (this.searchByType && this.searchMethodName)
    ...
    getByEscarbonMetaregistryList(data) {
      ...
      getEscarbonMetaregistryList(data).then((res) => {
        m.close();
    ...
    getByCarbonMetaregistryList(data) {
      getCarbonMetaregistryList(data).then((res) => {
        this.list = res.data.records;
        this.total = parseInt(res.data.total);
        this.current = parseInt(res.data.current);
        this.pageCount = Math.ceil(parseInt(res.data.total) / this.pageSize);
