  ...
  <div>
      ...
      <div class="filter-container mb20" v-if="tableFrom.type === 'sms'">
        <div class="demo-input-suffix">
          ...
          <router-link :to="{ path: '/operation/systemSms/template' }">
            <el-button type="primary" size="mini" class="mr20"
              >短信模板</el-button
            >
          </router-link>
    ...
    <div v-else>
      ...
      <div
        v-if="
          (tableFrom.type === 'sms' && !isSms) ||
            ...
            ((tableFrom.type === 'copy' || tableFrom.type === 'expr_query') &&
              !isCopy)
        "
      ...
      >
        ...
        <div class="mb15">
          <span class="wuSp1"
            >{{ tableFrom.type | onePassTypeFilter }}未开通哦</span
          >
          <span class="wuSp2"
            >点击立即开通按钮，即可使用{{
              tableFrom.type | onePassTypeFilter
            }}服务哦～～～</span
          >
        </div>
        <el-button
      ...
      <div
        class="smsBox"
        v-if="
          (isDump && tableFrom.type === 'expr_dump') ||
            (isSms && tableFrom.type === 'sms')
        "
      >
        <div class="index_from page-account-container">
          <div class="page-account-top">
            <span class="page-account-top-tit"
              >开通{{ tableFrom.type | onePassTypeFilter }}服务</span
            >
          </div>
          <el-form
            ref="formInlineDump"
...
export default {
  ...
  methods: {
    ...
    openOther() {
      this.$confirm(
        `确定开通${commFilter.onePassTypeFilter(this.tableFrom.type)}吗?`,
        "提示",
        {
