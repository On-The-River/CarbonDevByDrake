      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="sellerName" label-width="20%">
            <label slot="label"
              >供应方机构名称<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入供应方机构名称"
              v-model="detailData.sellerName"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="sellerContacts" label-width="20%">
            <label slot="label"
              >供应方联系人姓名<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入供应方联系人姓名"
              v-model="detailData.sellerContacts"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="sellerPhone" label-width="20%">
            <label slot="label"
              >供应方联系电话<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入供应方联系电话"
              v-model="detailData.sellerPhone"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="sellerEmail" label-width="20%">
            <label slot="label"
              >供应方邮箱<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入供应方邮箱"
              v-model="detailData.sellerEmail"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="buyerName" label-width="20%">
            <label slot="label"
              >采购方机构名称<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入采购方机构名称"
              v-model="detailData.buyerName"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="buyerContacts" label-width="20%">
            <label slot="label"
              >采购方联系人姓名<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入采购方联系人姓名"
              v-model="detailData.buyerContacts"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="buyerPhone" label-width="20%">
            <label slot="label"
              >采购方联系电话<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入采购方联系电话"
              v-model="detailData.buyerPhone"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="buyerEmail" label-width="20%">
            <label slot="label"
              >采购方邮箱<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入采购方邮箱"
              v-model="detailData.buyerEmail"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="tradeQuantity" label-width="20%">
            <label slot="label"
              >交易量(tCO2e)<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入交易量"
              v-model="detailData.tradeQuantity"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      <div class="item-div">
        ...
        >
          <el-form-item prop="assetUnitPrice" label-width="20%">
            <label slot="label"
              >协议价格(¥)<span style="color:red">*</span></label
            >
            <el-input
              placeholder="请输入协议价格"
              v-model="detailData.assetUnitPrice"
              size="medium"
              class="input-text"
            >
            </el-input>
      ...
      >
        <el-form-item prop="deliveryTime" label-width="20%">
          ...
          <el-date-picker
            ...
            v-model="detailData.deliveryTime"
            type="datetime"
            placeholder="请选择日期"
            align="right"
      ...
      >
        <el-form-item prop="deliveryMethod" label-width="20%">
          ...
          <el-cascader
            ...
            placeholder="全部"
            v-model="detailData.deliveryMethod"
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        assetUnitPrice: [{ required: true, message: "请输入交易量" }],
        deliveryMethod: [
  ...
  methods: {
    ...
    initParams() {
      ...
      if (this.data.tradeRole === "0270000001") {
        ...
        this.detailData.assetUnitPrice =
          this.data.buyerUnitPrice && this.data.buyerUnitPrice != "--"
            ? this.data.buyerUnitPrice
            : 0;
    ...
    updateType() {
      if (
        this.detailData.assetType[0] == "0140000002" ||
        this.detailData.assetType[0] == "0140000003"
      ) {
    ...
    clickSubmit() {
      ...
      MessageBox.confirm("", "提示", {
        ...
        this.clickClose();
        let tradeContract = {
          assetType: this.detailData.assetType
            ? this.detailData.assetType[0]
            : "",
          ...
          deliveryExchange: this.detailData.deliveryExchange
            ? this.detailData.deliveryExchange[0]
            : "",
          deliveryMethod: this.detailData.deliveryMethod
            ? this.detailData.deliveryMethod[0]
            : "",
        ...
        intendedTransaction(data)
          .then(res => {
            if (res.code == 200) {
              let exchangeName = "";
              for (let i = 0; i < this.exchangeList.length; i++) {
                if (
                  this.detailData.deliveryExchange == this.exchangeList[i].value
                ) {
