      ...
      <div class="content-container">
        ...
        <div class="cardBody">
          ...
          <div class="item-div">
            ...
            <span class="item-content" style="color: #1020ff; cursor: pointer"
          ...
          <span class="detail" @click="toDetail(assetDetail.projectIntroduction)"
        ...
        <br />
        <br>
        <img src="@/assets/icon/com_plant.png" alt="" class="icon" />
        ...
        <div class="basic-div" style="height: 174px">
          ...
          <div class="item-div">
            ...
            <br />
            <span class="item-content" style="color: #120fff; cursor: pointer" @click="toBuyFile">
        ...
        <div class="basic-div" style="height: 89px; background-color: white">
          <!-- 场内交易按钮 -->
          <button style="width: 90px; float: right" class="light-green-btn" @click="insideTransaction">
            场内交易
          </button>
          <!-- 场外报价按钮 -->
          <button style="width: 90px; float: right; margin-right: 20px" class="light-green-btn"
                  @click="outsideTransaction">
            场外报价
          </button>
          <!-- 返回按钮 -->
          <button style="width: 90px; float: right; margin-right: 20px" class="normal-white-btn"
                  @click="goBack">
            返回
          </button>
        </div>
        <!-- 场外报价弹窗 -->
        <el-dialog title="场外报价" :visible.sync="dialogFormVisible" width="720px">
          <el-form label-position="left" label-width="130px" :model="form" :rules="rules">
            ...
            <el-form-item label="期望交割场所" prop="deliveryExchange">
              <el-select v-model="form.deliveryExchange" placeholder="全国碳排放权交易中心、北京环境交易所、上海环境能源交易所"
                         size="medium" style="width: 550px; top: -5px">
        ...
        <!-- 报价确认弹窗 -->
        <el-dialog title="报价成功" :visible.sync="showQuotation" width="300px">
