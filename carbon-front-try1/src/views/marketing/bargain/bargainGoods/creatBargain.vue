            ...
            <el-col :span="24">
              <el-form-item label="商品轮播图：" prop="images">
                <div class="acea-row">
                  ...
                  <div
                    v-if="formValidate.imagess.length < 10"
                    class="upLoadPicBox"
                    @click="modalPicTap('2')"
                  >
                    <div class="upLoad">
      ...
      this.$modalUpload(
        function(img) {
          ...
          if (tit === "2" && !num) {
            ...
            if (img.length + _this.formValidate.imagess.length > 10)
              return this.$message.warning("最多选择10张图片！");
            img.map(item => {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          if (!this.radio) {
            ...
            if (!this.radio.price)
              return this.$message.warning("请填写砍价起始金额！");
            if (!this.radio.minPrice && this.radio.minPrice != 0)
              return this.$message.warning("请填写砍价最低价！");
