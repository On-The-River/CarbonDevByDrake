  ...
  <div class="divBox">
    <el-card class="box-card">
      ...
      >
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="推广人：">
                <span>{{
                  props.row.spreadInfo.id + " / " + props.row.spreadInfo.name
                }}</span>
              </el-form-item>
        ...
        <el-table-column prop="realName" label="用户信息" min-width="130" />
              ...
              >
                ...
                <div>
                  ...
                  <span class="tabBox_pice">{{
                    "￥" + val.info.productInfo.attrInfo.price
                      ? val.info.productInfo.attrInfo.price +
                        " x " +
                        val.info.cartNum
                      : "-"
        ...
        <el-table-column label="订单状态" min-width="150">
          <template slot-scope="scope">
            <div
              v-if="scope.row.statusStr.key === 'refunding'"
              class="refunding"
            >
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native="onOrderDetails(scope.row.id)"
                  >订单详情</el-dropdown-item
                >
                <el-dropdown-item @click.native="onOrderLog(scope.row.id)"
                ...
                >
                <el-dropdown-item
                  v-show="scope.row.statusStr.key === 'refunding'"
                ...
                <el-dropdown-item
                  v-show="
                    (scope.row.statusStr.key !== 'refunded' &&
                      scope.row.statusStr.key !== 'unPaid' &&
                      parseFloat(scope.row.payPrice) >=
                        parseFloat(scope.row.refundPrice)) ||
                      (scope.row.payPrice == 0 &&
                        [0, 1].indexOf(scope.row.refundStatus) !== -1)
                  "
                  @click.native="onOrderRefund(scope.row)"
                  >立即退款</el-dropdown-item
                >
                <el-dropdown-item
                  v-show="scope.row.statusStr.key === 'deleted'"
