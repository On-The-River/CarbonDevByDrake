            ...
            <div class="acea-row row-between-wrapper">
              ...
              <div class="checkTime">
                <el-radio-group v-model="visitDate" class="ivu-mr-8">
                  <el-radio label="last30" @change="handleChangeVisitType"
                    >30天</el-radio
                  >
                  <el-radio label="week" @change="handleChangeWeek"
                    >周</el-radio
                  >
                  <el-radio label="month" @change="handleChangeMonth"
                    >月</el-radio
                  >
                  <el-radio label="year" @change="handleChangeYear"
                    >年</el-radio
                  >
                </el-radio-group>
              </div>
