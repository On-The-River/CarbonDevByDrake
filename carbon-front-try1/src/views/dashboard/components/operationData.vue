<template>
  <div class="divBox">
      ...
      <el-col v-bind="grid" class="ivu-mb">
        <el-card :bordered="false">
          <div class="link">
            ...
            <p class="boxCarbonCertificationCount">
              {{ carbonCertificationCount }}
            </p>
          </div>
        </el-card>
      </el-col>
      <el-col v-bind="grid" class="ivu-mb">
        <el-card :bordered="false">
          <div class="link">
            ...
            <p class="boxCarbonMethodologyCount">
              {{ carbonMethodologyCount }}
            </p>
          </div>
        </el-card>
      </el-col>
    ...
    <div>
      ...
      >
        <el-table-column prop="amount" label="中和资产(CNC)" width="80px">
        </el-table-column>
        <el-table-column prop="typeName" label="资源类型" width="80px">
        </el-table-column>
        <el-table-column prop="uom" label="资产UOM" width="80px">
        </el-table-column>
        <el-table-column
